...
const getTypeGradient = (types) => {
  ...
  const typeColors = {
    ...
    Sol: 'from-yellow-700 to-yellow-700',
    Vol: 'from-blue-200 to-blue-300',
    Psy: 'from-pink-300 to-pink-700',
    Insecte: 'from-lime-300 to-lime-700',
    Roche: 'from-yellow-700 to-yellow-800',
    Spectre: 'from-indigo-300 to-indigo-700',
    Dragon: 'from-purple-700 to-purple-700',
    Ténèbres: 'from-gray-700 to-gray-800',
    Acier: 'from-gray-300 to-gray-700',
    Fée: 'from-pink-200 to-pink-300',
  };
